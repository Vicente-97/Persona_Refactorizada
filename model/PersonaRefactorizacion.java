...
public class PersonaRefactorizacion {
	...
	public PersonaRefactorizacion(String nombre, String apellido, String dni) {
		super();
	...
	public PersonaRefactorizacion(String nombre, String apellido, String dni, LocalDate fechaNacimiento, String genero) {
	...
	//metodo extraido para saber si es DNI
